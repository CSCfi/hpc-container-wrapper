...
from script_shared import add_base_pars, add_prefix_flag, parse_wrapper  # noqa: E402

sys.argv[0] = sys.argv[0].split("/")[-1].split(".")[0]
parser = argparse.ArgumentParser(
    description="Create wrappers for executables inside a container"
)
parser.add_argument(
    "container", type=str, help="Container to wrap, can be docker/singularity url"
)
